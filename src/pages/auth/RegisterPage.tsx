      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-black/10 border backdrop-blur-lg border-white/50">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Join IdeaHub and start sharing your ideas
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 rounded-lg text-white/90 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-500 font-bold transition-all flex items-center justify-center gap-2"
          >
