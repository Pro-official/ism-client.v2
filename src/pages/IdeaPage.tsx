...
export default function IdeaPage() {
  ...
  if (!idea) {
    return (
      ...
      >
        <div className="text-white/90 text-center"> Idea not found. </div>
      </motion.div>
    );
  }
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4">
        <div className="rounded-2xl overflow-hidden bg-black/10 border border-white/50">
          {" "}
          {/* Original class */}
          <div className="p-8">
            ...
            <h1 className="lg:text-2xl mb:text-xl font-bold text-white/90 mb-4">
              {idea.title}
            </h1>
          </div>
          {/* <img
          ...
          <div className="p-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black/10 text-gray-400 hover:bg-black/10/10 hover:text-white/90 transition-colors"
              >
                <MessageCircle className="w-5 h-5" />
                <span>Comments</span>
              </button>
              <Link to={`/collaboration/${idea._id}`}>
                <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black/10 text-gray-400 hover:bg-black/10/10 hover:text-white/90 transition-colors">
